                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="form-group col-sm-6 col-xs-12">
                            ...
                            <label id="role" name="role" class="form-control"><?php echo $userRole ?></label>
                        </div>
                        <div class="form-group col-sm-3 col-xs-12">
                            <label for="engagedDate">Date Engaged</label>
                            <label id="engagedDate" name="engagedDate" class="form-control"><?php echo $engagedDate ?></label>
                        </div>
                        <div class="form-group col-sm-3 col-xs-12">
                            <label for="verified">Verified?</label>
                            <label id="verified" name="verified" class="form-control"><?php echo ($verified == 1 ? "Yes" : "No") ?></label>
                        </div>
                    </div>
                </div>
                <!-- /.box-body -->
